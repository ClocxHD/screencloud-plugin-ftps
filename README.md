# screencloud-plugin-ftps [![Build Status](https://travis-ci.org/ClocxHD/screencloud-plugin-ftps.svg?branch=master)](https://travis-ci.org/ClocxHD/screencloud-plugin-ftps)
